...
function Cardpart() {
    ...
    return (
            ...
            <div className="cardpardone-m">
                    ...
                    <div className="cardpart-m">
                <Col >
                <Card  style={{border:'none' ,borderRadius:'0',width:'80vw',marginRight:'0vw',marginLeft:'0vw',marginBottom:'3vh'}}>
                
                <div className="headercardarea-m">
                ...
                <Row>
                        ...
                        <Col>
                        <div className="iconcardarea-m">
                            
                            
                           <button type="button" className="Hearthcard"><FiHeart/></button>
                            <button type="button" onClick={onclick} className="sharecard" onMouseOut><HiShare/></button>
                            {
                   ...
                   <Row>
                           ...
                           <div className="iconcardarea-m">
                              ...
                              <button type="button" className="Hearthcard"><FiHeart/></button>
                               <button type="button" onClick={onclick} className="sharecard" onMouseOut><HiShare/></button>
                               {
                               show?<div className="sharecardarea-m">
                               <div className="Shateitemhover-m">
                               <a ><FaWhatsapp/></a>
                               </div>
                               <div className="Shateitemhover-m">
                               <a><FaInstagram/></a>
