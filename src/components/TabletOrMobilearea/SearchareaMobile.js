...
const Searcharea = () => {
  const props = useSpring({ to: { opacity: 1 ,y:18}, config: { duration: 800 }, from: { opacity: 0 ,y:-500 } })
    ...
    return (
        <div className="searcharea-m">
            {/* <Container > */}
             <Row >
             <Col>
             <form>
                 <div className="formarea-m">
                ...
                {/* <input type="submit" value={<IoIosSearch/>}/> */}
                <button  type="button" onClick={onclick} ><AiOutlineSetting style={{fontSize:"1.5rem"}}/></button>
                <button type="submit"><IoIosSearch style={{fontSize:"1.5rem"}}/></button>
                </div>
                
                {
                 show?
                   ...
                   <animated.div style={props} className="Advancesearch-m">
                <form>
               ...
               {
                   Viewsearch?<div className="Facilities-m">
                   <div>
